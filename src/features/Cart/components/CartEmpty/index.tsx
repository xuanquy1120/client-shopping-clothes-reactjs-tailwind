  ...
  return (
    <>
      <div className="w-full p-10 h-[75vh]    rounded-md bg-[#F5F5F5] flex flex-col justify-center items-center select-none">
        ...
        <Link to="/product" className='shadow-lg border-lg rounded-md px-10 py-2 bg-blue-700 text-white hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium  text-sm'>Continue shopping</Link>
      </div>
    </>
  );
};
